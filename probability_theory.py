...
probability_all_white = (comb(7, 2) / comb(10, 2)) * (comb(9, 2) / comb(11, 2))

probability_two_white = (comb(7, 2) / comb(10, 2)) * (comb(2, 2) / comb(11, 2)) + (comb(3, 2) / comb(10, 2)) * (comb(9, 2) / comb(11, 2))

probability_at_least_one_white = 1 - (comb(3, 2) / comb(10, 2)) * (comb(2, 2) / comb(11, 2))

print(f"Вероятность, что все мячи белые: {probability_all_white:.4f}")
print(f"Вероятность, что ровно два мяча белые: {probability_two_white:.4f}")
print(f"Вероятность, что хотя бы один мяч белый: {probability_at_least_one_white:.4f}")
